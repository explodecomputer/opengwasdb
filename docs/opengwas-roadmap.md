...
- One approach might be to make numerous different reference panels, and then use allele frequency alignment between target GWAS and reference to select the best reference.
...
- Decide the first official store partitioning strategy: by ancestry, data source, assay, release, or a combination.
